...
func CanonicalResult(result domain.AnalysisResult) (domain.AnalysisResult, error) {
	...
	if out.Segment != nil {
		segment := *out.Segment
		value, err := canonicalFloat(segment.ColdPointC)
		if err != nil {
			return domain.AnalysisResult{}, err
		}
		segment.ColdPointC = value
		out.Segment = &segment
	}
	out.Metrics = append([]domain.ProbeMetric(nil), result.Metrics...)
	...
	out.Findings = append([]domain.Finding(nil), result.Findings...)
